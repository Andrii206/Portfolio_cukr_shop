    ...
    <div class="container  ">
        <header class="bg-body sticky-top d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                <img height="75" src="assetc/a2c9c6a8f2a0c2b359901b4f06f69d38.png">
            </a>
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3  d-flex align-items-center" role="search">
            ...
            <ul class="nav nav-pills d-flex align-items-center">
                ...
                <li class="nav-item"><a href="#" class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-25-hover mx-2">Кошик</a></li>
            </ul>
